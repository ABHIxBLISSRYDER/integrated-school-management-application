...
// Main component for individual student profile
const SingleStudentPage = async ({
  ...
  // Fetch student data including class info and lesson count
  const student:
    | (Student & {
  ...
  // Return 404 page if student not found
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-Sky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              {/* Extra Info: Blood type, Birthday, Email, Phone */}
